locals {
  ...
  opencti_hostname                                   = "${var.corp}-${var.component}-${var.staging}"
  opencti_datadisk_name                              = "${var.corp}-${var.component}-data-disk-${var.staging}"

  elastic_nic_name                                   = "${var.corp}-${var.component}-${each.key}-nic-${var.staging}"
  elastic_ipconf_name                                = "${var.corp}-${var.component}-${each.key}-ipconf-${var.staging}"
  elastic_vm_name                                    = "${var.corp}-${var.component}-${each.key}-vm-${var.staging}"
  elastic_osdisk_name                                = "${var.corp}-${var.component}-${each.key}-os-disk-${var.staging}"
  elastic_hostname                                   = "${var.corp}-${var.component}-${each.key}-${var.staging}"
  elastic_datadisk_name                              = "${var.corp}-${var.component}-${each.key}-data-disk-${var.staging}"
